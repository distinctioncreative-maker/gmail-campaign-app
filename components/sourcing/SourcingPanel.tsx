      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <label className="text-sm">
          ...
          <input
            ...
            className="mt-1 min-h-11 w-full rounded-xl border border-border bg-surface px-3 py-2.5 text-sm focus:border-primary focus:outline-none"
          />
        </label>
        <label className="text-sm">
      ...
      <div className="mt-4 flex flex-wrap items-end gap-3">
        <label className="text-sm">
          ...
          <select
            ...
            className="mt-1 block min-h-11 rounded-xl border border-border bg-surface px-3 py-2.5 text-sm focus:border-primary focus:outline-none"
          >
            {[10, 25, 50].map((n) => (
