  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: "shipped",
        description: "Dashboard content can use a 1440px workspace for dense reporting and editing without clipping. A source-level regression test also keeps em dashes out of application copy so new UI follows the product voice consistently.",
        keyFiles: ["app/(dashboard)/layout.tsx", "tests/unit/copy-style.test.ts"],
      },
    ],
  },
];
