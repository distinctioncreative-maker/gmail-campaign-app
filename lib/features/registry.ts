  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: "beta",
        description: "A shared components/ui/EmptyState.tsx (icon, plain-language title/description, optional CTA) replaces ad hoc duplicated empty-state markup on Templates, Campaigns, Sequences, and Replies. The home page's count-up number component moved to components/ui/CountUp.tsx (it was never home-specific) and now drives the Reports KPI tiles, the open/click tracking card, and campaign-detail stat tiles, not just Home and Team. List/grid rows on Templates, Campaigns, and Sequences get a staggered fade-in entrance instead of appearing all at once. Rolled out to the highest-traffic list pages first; the rest of the app follows in the same pattern.",
        keyFiles: ["components/ui/EmptyState.tsx", "components/ui/CountUp.tsx", "app/(dashboard)/reports/page.tsx", "app/(dashboard)/campaigns/[campaignId]/page.tsx"],
      },
    ],
  },
];
