  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: "shipped",
        description: "Off by default and clearly labeled as a deliverability tradeoff. Expiring, signed tokens drive rate-limited open and click endpoints; redirects are restricted to stored HTTP(S) links, and counters update transactionally under concurrent image/link loads. The unsubscribe link is never rewritten.",
        keyFiles: [
